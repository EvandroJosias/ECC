...
public class JPanelPad extends JPanel {
	...
	public JLabelPad add(Component comp, int X, int Y, int Larg, int Alt, String label) {
		JLabelPad lbTmp = new JLabelPad(label);
		add(lbTmp, X, Y - 20, Larg, 20);
		add(comp, X, Y, Larg, Alt);
		return lbTmp;

	}
	
	public void add(Component comp, int x, int y, int larg, int alt) {
